...
class SampleContract extends Contract {
    ...
    constructor(protocol, options = {}) {
        ...
        // unique command pair for this fork:
        // promote_delivery_lane + trace_delivery_lane
        this.addSchema('promoteDeliveryLaneStatus', {
            value : {
                $$strict : true,
                $$type: "object",
        ...
        this.addFunction('readDeliveryLaneStatus');
    ...
    async promoteDeliveryLaneStatus(){
        ...
        console.log('delivery lane updated', laneCard);
    }

    async readDeliveryLaneStatus(){
